  ...
  head: () => ({
    meta: [
      ...
      { title: "Honey Chain — Blockchain Honey Traceability" },
      {
        name: "description",
        content:
          "Honey Chain by Team Brain Hustlers: IoT hive monitoring, lab testing, blockchain records and QR traceability for honey.",
      },
      { name: "author", content: "Team Brain Hustlers" },
    ],
    links: [
      {
        rel: "stylesheet",
